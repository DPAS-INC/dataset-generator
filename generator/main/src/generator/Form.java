...
public class Form extends javax.swing.JFrame {
   ...
   /*
    * Following code fields had been auto-generated by the NetBeans GUI builder (lines 42 to 220)
   ...
   */
   public Form() {
      // Line below was auto-generated by the NetBeans GUI builder, remaining body of constructor was written by myself
      initComponents();
   ...
   /*
   * initComponents: Method that had been auto-generated by the NetBeans GUI builder
   * Lines 399 to 2487 were auto-generated
   * This tutorial was followed for the basic layout of the design in the GUI builder (1:22 to 2:23): https://www.youtube.com/watch?v=L-UPOw1nHCI
   * Most design features were changed and built upon by myself
   * The positioning, appearance, and contents of the components in the following code were entered/positioned manually by myself in the GUI builder
   */
   ...
   private void load(){
      ...
      try{
         ...
         for (String key : labOutputs.keySet()) {
            ...
            // Below data labels form part of the DG-13a requirement (from Appendix D - Requirements of the Project Report)
   ...
   private void processDescSubmitButtonActionPerformed() {
      ...
      if (!checkEmpty(processDescModel)){
         ...
         desc.clear();
         for (int i = 0; i < row; i++){
            // Below data labels form part of the DG-24 requirement (from Appendix D - Requirements of the Project Report)
   ...
   private void inputSubmitButtonActionPerformed() {
      ...
      if (!checkEmpty(inModel)){
         ...
         // Below data labels form part of the DG-2 and DG-6 requirements (from Appendix D - Requirements of the Project Report)
   ...
   private void stateSubmitButtonActionPerformed() {
      ...
      if (!checkEmpty(stateModel)){
         ...
         // Below data labels form part of the DG-4 requirement (from Appendix D - Requirements of the Project Report)
         state.put(1, 1, "State");
   ...
   private void setOutput(){
      // Below data labels form part of the DG-3 requirement (from Appendix D - Requirements of the Project Report)
   ...
   private void genButtonActionPerformed() {
      ...
      // Below data labels form part of the DG-2 and DG-4 requirements (from Appendix D - Requirements of the Project Report)
   ...
   private void run(LocalTime start){
       ...
       */
      {
         // This line had the variable name changed and the types '<Boolean, String>' added
         ...
         SwingWorker<Boolean, String> sw = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground(){
               // This method includes a try/catch statement instead of throwing an exception in the method signature
               try{
                  /*
            ...
            protected void process(List s) {
               // The 's.size() - 1' part only was adapted from the tutorial, the rest was written by myself
            ...
            protected void done() {
               ...
               try {
                  ...
                  // The catch block was condensed from the SwingWorker tutorial and additional lines were added by myself
