 ...
 * The class/constructor shell was created by the NetBeans GUI builder
 */
public class Form extends javax.swing.JFrame {

   /*
    * Following code fields had been auto-generated by the NetBeans GUI builder
    * (lines 42 to 220)
    * The variable components were added and named by myself on the GUI builder
    */
   ...
   private javax.swing.JTextField isolatedField;
   private javax.swing.JLabel isolatedLabel;
   ...
   /*
    * This constructor initialises the components and variables of the class
    * The constructor shell was auto-generated by the NetBeans GUI builder
    */
   public Form() {
      // Line below was auto-generated by the NetBeans GUI builder, remaining body of
      // constructor was written by myself
      initComponents();
      // Initialising data structure components
      ...
      // Initialising additional JComboBoxes
   ...
   /*
    * initComponents: Method that had been auto-generated by the NetBeans GUI
    * builder
    * Lines 399 to 2487 were auto-generated
    * This tutorial was followed for the basic layout of the design in the GUI
    * builder (1:22 to 2:23): https://www.youtube.com/watch?v=L-UPOw1nHCI
    * Most design features were changed and built upon by myself
    * The positioning, appearance, and contents of the components in the following
    * code were entered/positioned manually by myself in the GUI builder
    */
   ...
   private void initComponents() {
      ...
      isolatedLabel = new javax.swing.JLabel();
      isolatedField = new javax.swing.JTextField();
      ...
      welcomeLabel.setText(
            "<html>Dataset Generator, Pat Dixon, Alia Rezvi,<br>Mohammed Almakki, Grace Mower, Zaid Taiyab,<br>Deepak Dalai, (DPAS Inc), 2025</html>");
      ...
      isolatedLabel.setBackground(new java.awt.Color(0, 0, 0));
      isolatedLabel.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
      isolatedLabel.setForeground(new java.awt.Color(0, 0, 0));
      isolatedLabel.setText("Isolated Moves");

      isolatedField.setBackground(new java.awt.Color(255, 255, 255));
      isolatedField.setForeground(new java.awt.Color(0, 0, 0));
   ...
   // The following methods adjust the UI
   ...
   private void dialog(String text, String name) {
       ...
       * Variable name and text parameters were changed
       */
   ...
   private void loadFolderButtonActionPerformed(java.awt.event.ActionEvent evt) {
      ...
      if (result == JFileChooser.APPROVE_OPTION) {
         ...
         loadMessageLabel.setText("No folder selected.");
      }
   }
   ...
   private void submitProcessButtonActionPerformed() {
      ...
      if (date.isEmpty() || lab.isEmpty() || processPeriod.isEmpty() || pulp.isEmpty() || qcs.isEmpty() ||
         ...
         // Below data labels form part of the DG-11 requirement (from Appendix D -
         // Requirements of the Project Report)
   ...
   private void processDescSubmitButtonActionPerformed() {
      ...
      if (!checkEmpty(processDescModel)) {
         ...
         desc.clear();
         for (int i = 0; i < row; i++) {
            // Below data labels form part of the DG-24 requirement (from Appendix D -
            // Requirements of the Project Report)
   ...
   private void inputSubmitButtonActionPerformed() {
      ...
      if (!checkEmpty(inModel)) {
         ...
         // Below data labels form part of the DG-2 and DG-6 requirements (from Appendix
         // D - Requirements of the Project Report)
   ...
   private void stateSubmitButtonActionPerformed() {
      ...
      if (!checkEmpty(stateModel)) {
         ...
         // Below data labels form part of the DG-4 requirement (from Appendix D -
         // Requirements of the Project Report)
         state.put(1, 1, "State");
   ...
   private void setOutput() {
      // Below data labels form part of the DG-3 requirement (from Appendix D -
      // Requirements of the Project Report)
   ...
   private void genButtonActionPerformed() {
       ...
       * contain-2-values
       * The variables and boolean condition were changed
       */
   ...
   private void run(LocalTime start) {
       ...
       * Any changes are mentioned below
       */
      {
         // This line had the variable name changed and the types '<Boolean, String>'
         // added
         ...
         SwingWorker<Boolean, String> sw = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() {
               // This method includes a try/catch statement instead of throwing an exception
               // in the method signature
               try {
                  /*
                   * Contents of this method were all changed to include the dataset generation
                   * The publish() method has different parameters
                   */
            ...
            protected void process(List s) {
               // The 's.size() - 1' part only was adapted from the tutorial, the rest was
               // written by myself
            ...
            @Override
            protected void done() {
               // The contents of the try block were not used from the SwingWorker tutorial
               try {
                  ...
                  if (get()) {
                      ...
                      * two-time-periods/
                      * Some variables and text in String were changed
                      */
                  ...
                  // The catch block was condensed from the SwingWorker tutorial and additional
                  // lines were added by myself
         ...
         // This line was adapted from the SwingWorker tutorial (variable name changed)
         sw.execute();
      }
   ...
   /*
    * downloadButtonActionPerformed: Method when clicking on the Select Folder
    * button
    * Method shell (not body) was auto-generated from the GUI builder
    */
