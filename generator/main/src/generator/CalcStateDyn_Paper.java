...
public class CalcStateDyn_Paper {
    ...
    public void CalcStateDyn_Paper() {
        ...
        for (int i = 3; i <= finalRow; i++) {
            ...
            data.put(i, searchCol("QCS_Moisture", data), String.valueOf(
                    moistureAsymptote + (moistureToDryers - moistureAsymptote) / Math.exp(steamPressure / 25)));
            if (machineSpeed <= 1)
                boneDryWeight = 0;
            else
            ...
            data.put(i, searchCol("QCS_Caliper", data), String.valueOf(
